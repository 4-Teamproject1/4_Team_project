...
document.addEventListener("DOMContentLoaded", function() {
    const departureBox = document.querySelector('.departure_box');
    const arrivalBox = document.querySelector('.arrival_box');
    ...
    const departureAreas = [ "경주", "구리", "광주<br>(유·스퀘어)", "남원", "나주", "대전복합",
		"대전도룡", "대전청사<br>(샘머리)", "유성", "동대구", "동서울", "센트럴시티<br>(서울)",
		"목포", "부산", "부산사상", "서울경부", "성남(분당)", "세종시청", "세종연구단지", "세종청사",
		"세종터미널", "순천", "시흥", "수원", "죽전", "전북혁신", "전주", "제천", "진해",
		"창원역", "천안", "청주(센트럴)", "청주공항", "청주북부", "충주", "충주<br>고속터미널",
		"포항", "포항시청", "여수", "용인", "용인신갈", "의정부", "이천", "인천공항T1",
		"인천공항T2", "자치인재원" ];

    // Arrival terminal list
    const arrivalAreas = [ "경주", "구리", "광주<br>(유·스퀘어)", "남원", "나주", "대전복합",
		"대전도룡", "대전청사<br>(샘머리)", "유성", "동대구", "동서울", "센트럴시티<br>(서울)",
		"목포", "부산", "부산사상", "서울경부", "성남(분당)", "세종시청", "세종연구단지", "세종청사",
		"세종터미널", "순천", "시흥", "수원", "죽전", "전북혁신", "전주", "제천", "진해",
		"창원역", "천안", "청주(센트럴)", "청주공항", "청주북부", "충주", "충주<br>고속터미널",
    ...
    departureAreas.forEach(function(area) {
        ...
        areaElement.addEventListener('click', function() {
            departureBox.value = area.replace(/<br>/g, ' '); // Set the value of the departure input field to the selected area
...
<div class="sort_bar">
	<input class="terminal_box arrival_box" type="text" placeholder="줄발지">
	<input class="terminal_box departure_box" type="text" placeholder="도착지">
