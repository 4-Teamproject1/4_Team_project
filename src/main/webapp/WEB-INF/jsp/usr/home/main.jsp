...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const searchBox = document.querySelector(".btnSearch .SearchBoxTextEditor");
    const searchResults = document.querySelector(".btnSearch .search_results");
    // 데이터
    const data = [
      "한일차세대학술포럼",
      "한국미디어문화학회 학술대회",
    ...
    document.body.addEventListener("click", function(event) {
      if (!event.target.closest(".btnSearch")) {
        searchResults.classList.remove("visible");
      }
    });
  });
...
<div id="slider">
  ...
  <a href="#" class="control_prev">◁</a>
      <ul>
        ...
        <li style="background-image: url('https://velog.velcdn.com/images/vrslxowe/post/f24773fc-db1f-413f-93bf-814723438bb6/image.jpg'); background-size: cover; background-position: center;">
        </li>
            ...
            <div class="event-card-content">
              <div class="event-details">
                <div class="event-info">
                  ...
                  <button class="event-description">한일차세대학술포럼
                    <span class="event-date">04.05</span>
                  </button>
                  <button class="event-description">한국미디어문화학회 학술대회
                    <span class="event-date">05.11</span>
                  </button>
                  <button class="event-description">국제성인역량조사(PIAAC) 학술대회
                    <span class="event-date">06.28</span>
                  </button>
                  <button class="event-description">환태평양 정신의학회 학술대회
                    <span class="event-date">11.18</span>
                  </button>
                </div>
              </div>
            ...
            <div class="event-card-content">
              <div class="event-details">
                <div class="event-info">
                  ...
                  <button class="event-description">KT&G 상상실현 콘테스트
                    <span class="event-date-2">04.21</span>
                  </button>
                  <button class="event-description">제6회 교육 공공데이터 분석·활용대회
                    <span class="event-date-2">05.22</span>
                  </button>
                  <button class="event-description">CICA 미술관 국제전 “Drawing Now 2024” 공모
                    <span class="event-date-2">10.05</span>
                  </button>
                  <button class="event-description">사하 수필공모전
                    <span class="event-date-2">11.22</span>
                  </button>
                </div>
              </div>
              <a href="#" class="event-more-button">더보기</a>
...
<style type="text/css">
  ...
  *:after {
  ...
  .search_results {
    position: relative;
    top: calc(100% + 38px);
    /* SearchBoxTextEditor 아래에 위치하도록 설정 */
    left: 60%;
