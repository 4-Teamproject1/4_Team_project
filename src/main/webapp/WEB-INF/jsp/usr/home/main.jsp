...
<div class="menu_right">
	<a href="../member/myQuestion">
		<button class="mypage">학회 정보</button>
	</a> <a href="../member/myQuestion">
		<button class="menu_box2 myquestion">문의사항</button>
	</a> <a href="../member/myInfo">
		<button class="menu_box2 myinfo">로그인</button>
	</a> <a href="../member/myInfo">
		<button class="menu_box2 myinfo">회원가입</button>
	</a>
</div>
...
<section>
	<div class="search_box_main">
		<div class="search_box_custom ">
			<div class=" ">
				<div class="btnSearch">
					<input type="text" class="SearchBoxTextEditor "
						placeholder="어디로 떠나시나요?" id="textInput" value="">
				</div>
			</div>
		</div>
		<div class="search_box ">
			<div>
				<input type="text" class="box_start " placeholder="출발장소"
					id="textInput" value="" />
			</div>
			<div>
				<input type="text" class="box_end " placeholder="도착장소"
					id="textInput" value="" />
			</div>
			<div>
				<input type="text" class="box_date " placeholder="가는날"
					id="textInput" value="" />
			</div>
...
>>>>>>> 97f83f7098e7a62fccd6101e839790fc46c85ad3
>>>>>>> ee6ae0eb5f74987d4ff934c3f64aa791c5adaf8d
</style>