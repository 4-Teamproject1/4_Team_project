...
public class UsrArticleController {
	...
	public String recommendAirplaneList(HttpServletRequest req, Model model, @RequestParam(defaultValue = "1") int boardId,
		...
		return "usr/article/recommendAirplaneList";
	}
	
	@RequestMapping("/usr/article/recommendlist")
	public String recommendlist(HttpServletRequest req, Model model, @RequestParam(defaultValue = "1") int boardId,
			@RequestParam(defaultValue = "1") int page,
			@RequestParam(defaultValue = "title,body") String searchKeywordTypeCode,
			@RequestParam(defaultValue = "") String searchKeyword) {
		...
		return "usr/article/recommendlist";
	}
