...
public class ConferenceInfoCrawler7 {
        ...
        for (WebElement category : categories) {
            ...
            for (WebElement conferenceElement : conferenceElements) {
                ...
                try {
					...
					/*
					 * // 뒤로 가기가 아니라 학회 목록 페이지로 돌아가서 다음 학회의 상세 페이지로 이동 driver.get(url); // 다음 학회의 상세
					 * 페이지로 이동하기 위해 새로운 conferenceLink 요소를 찾음 conferenceLink =
					 * driver.findElement(By.xpath(
					 * "//a[@href='/research/researches/33/recruitments/112/recruits?listType=ING']"
					 * )); conferenceLink.click();
					 */
                }
               /* // 뒤로 가기가 아니라 학회 목록 페이지로 돌아가서 다음 학회의 상세 페이지로 이동
                driver.get(url);
                // 다음 학회의 상세 페이지로 이동하기 위해 새로운 conferenceLink 요소를 찾음
                conferenceLink = driver.findElement(By.xpath("//a[@href='/research/researches/33/recruitments/112/recruits?listType=ING']"));
                conferenceLink.click();*/
            }
            // 뒤로 가기
