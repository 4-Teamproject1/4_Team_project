...
public class ConferenceInfoCrawler2 {
	...
	public static void main(String[] args) {
		...
		for (WebElement conferenceElement : conferenceElements) {
			...
			WebElement titleElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[@class='title titleImageNone']")));
			...
			/*
			 * // 상세페이지로 이동한 후 "한국미래기술교육연구원 전기차 충전 인프라 사업 확대를 위한 기술 고도화 및 서비스 다양화 방안"이라는텍스트를
			 * 가진 // 요소를 찾아 클릭 WebElement detailLink = driver.findElement(By.
			 * xpath("//span[contains(text(), '세미나허브 미래 도심항공모빌리티(UAM) 상용화사업 추진전략 세미나')]"));
			 * detailLink.click();
			 */   
			...
			List<WebElement> contactRows = driver
					.findElements(By.xpath("//table[@class='contentSummaryInfo']/tbody/tr"));
			...
			/*
			 * // "지도보기" 링크 요소를 찾습니다. WebElement mapViewLink =
			 * driver.findElement(By.id("dynamicMapShow")); // 해당 링크를 클릭하여 지도를 표시합니다.
			 * mapViewLink.click(); WebDriverWait wait = new WebDriverWait(driver,
			 * Duration.ofSeconds(30)); // 최대 10초까지 기다립니다. // 주소 정보를 추출합니다. WebElement
			 * mapAddressView =
			 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(
			 * "mapAddressView"))); WebElement addressElement =
			 * mapAddressView.findElement(By.className("address")); String 주소2 =
