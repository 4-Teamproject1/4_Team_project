...
public class ConferenceInfoCrawler {
	...
	public static void main(String[] args) {
		...
		// 상세페이지로 이동한 후 "한국미래기술교육연구원 전기차 충전 인프라 사업 확대를 위한 기술 고도화 및 서비스 다양화 방안"이라는텍스트를 가진
		// 요소를 찾아 클릭
		WebElement detailLink = driver.findElement(By.xpath("//span[contains(text(), '세미나허브 미래 도심항공모빌리티(UAM) 상용화사업 추진전략 세미나')]"));
		detailLink.click();
