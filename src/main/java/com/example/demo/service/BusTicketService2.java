...
public class BusTicketService2 {
    ...
    static class BusCrawler {
        ...
        public List<Bus> buscrawl() {
            ...
            List<WebElement> routeElements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector("div.route_wrap")));
        ...
        private static Bus extractBusInfo(WebElement pElement) {
            List<WebElement> spanElements = pElement.findElements(By.cssSelector("span[class^='start_time'], span[class^='bus_info'], span[class^='remain']"));
            Bus bus = new Bus();
            for (WebElement spanElement : spanElements) {
            ...
            List<WebElement> busInfoElementgrade = pElement.findElements(By.cssSelector("p[data-time] > a > span.bus_info > span.grade_mo"));
